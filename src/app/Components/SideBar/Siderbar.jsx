...
function SideBar() {
  return (
    <ul className={style.container}>
      <Link className={style.Link} href="Components/skills">
        <li className={style.icons}>
          ...
          <span className={style.text}>About Me</span>
        </li>
      </Link>
      ...
      <Link className={style.Link} href="Components/skills">
        <li className={style.icons}>
          ...
          <span className={style.text}>Skills</span>
        </li>
      </Link>
      ...
      <Link className={style.Link} href="Components/skills">
        <li className={style.icons}>
          ...
          <span className={style.text}>Experience</span>
        </li>
      </Link>
